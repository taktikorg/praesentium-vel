...
[![npm](https://img.shields.io/npm/v/@taktikorg/praesentium-vel.svg)](https://www.npmjs.com/package/@taktikorg/praesentium-vel)
[![downloads](https://img.shields.io/npm/dt/@taktikorg/praesentium-vel.svg)](https://www.npmjs.com/package/@taktikorg/praesentium-vel)
[![types](https://img.shields.io/npm/types/@taktikorg/praesentium-vel.svg)](https://www.npmjs.com/package/@taktikorg/praesentium-vel)
[![licence](https://img.shields.io/github/license/mnasyrov/@taktikorg/praesentium-vel.svg)](https://github.com/taktikorg/praesentium-vel/blob/master/LICENSE)
[![Coverage Status](https://coveralls.io/repos/github/mnasyrov/@taktikorg/praesentium-vel/badge.svg?branch=main)](https://coveralls.io/github/mnasyrov/@taktikorg/praesentium-vel?branch=main)
...
| --------------------------------------------- | ------------------------------------------ | ---------------------------------------------------------- |
| [**@taktikorg/praesentium-vel**][@taktikorg/praesentium-vel/docs]             | Core elements, state and effect management | [Docs][@taktikorg/praesentium-vel/docs], [API][@taktikorg/praesentium-vel/api]             |
| [**@taktikorg/praesentium-vel-react**][@taktikorg/praesentium-vel-react/docs] | Tooling for React.js                       | [Docs][@taktikorg/praesentium-vel-react/docs], [API][@taktikorg/praesentium-vel-react/api] |
...
```
npm install @taktikorg/praesentium-vel @taktikorg/praesentium-vel-react --save
```
...
import {
  ...
  Query,
  withStoreUpdates,
} from '@taktikorg/praesentium-vel';
...
import { useConst, useObservable, useQuery } from '@taktikorg/praesentium-vel-react';
...
[@taktikorg/praesentium-vel/docs]: packages/@taktikorg/praesentium-vel/README.md
[@taktikorg/praesentium-vel/api]: packages/@taktikorg/praesentium-vel/docs/README.md
[@taktikorg/praesentium-vel-react/docs]: packages/@taktikorg/praesentium-vel-react/README.md
[@taktikorg/praesentium-vel-react/api]: packages/@taktikorg/praesentium-vel-react/docs/README.md
